...
{
    public static void InitializeStackMapper<TEndpoint>(TEndpoint endpoint)
    {
        var mapper = new StackMapper();
        ...
        while (currentType is not null)
        {
            var mapperField = currentType
                ...
                .FirstOrDefault(f => f.FieldType == typeof(StackMapper));
        ...
        throw new InvalidOperationException("Could not initialize StackMapper for endpoint test.");
    }
}
